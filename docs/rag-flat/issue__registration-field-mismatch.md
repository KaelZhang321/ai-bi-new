...
kb: meeting-bi
doc_type: issue
source_path: docs/rag/issues/registration-field-mismatch.md
source_file: registration-field-mismatch.md
title: 问题卡：报名与画像字段口径混用
summary: 当前客户相关模块大量使用 `real_identity`，但前端和旧文档中常把它表述为“金额等级”，存在字段语义错位。
language: zh-CN
