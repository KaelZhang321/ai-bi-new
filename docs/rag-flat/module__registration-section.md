...
kb: meeting-bi
doc_type: module
source_path: docs/rag/modules/registration-section.md
source_file: registration-section.md
title: 模块卡：报名 VS 签到情况
summary: 该模块通过堆叠柱图和矩阵表展示各大区客户报名与抵达情况，并支持按区域与标签下钻客户明细。
language: zh-CN
