...
kb: meeting-bi
doc_type: api
source_path: docs/rag/apis/source-target-detail.md
source_file: source-target-detail.md
title: 接口卡：目标客户明细
summary: `GET /v1/source/target-detail` 按区域返回目标客户详细信息和是否抵达状态，用于目标客户下钻弹窗。
language: zh-CN
